...
def open():
  ...
  try:
    print('Trying to open DS9.  You can ignore the XPA error below.')
    get('version') #Check if ds9 is already open
  except: #If the above errors that likely means ds9 isn't open so...
